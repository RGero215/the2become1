...
class StoresLoginController: UIViewController {
    ...
    @objc fileprivate func handleBack() {
        self.present(VendorOrCouple(), animated: true, completion: nil)
    }
    ...
    fileprivate func setupBindables() {
        loginViewModel.isFormValid.bind { [unowned self] (isFormValid) in
            ...
            self.loginButton.backgroundColor = isFormValid ? .gold() : .white
        ...
        loginViewModel.isLoggingIn.bind { [unowned self] (isRegistering) in
            if isRegistering == true {
                self.loginHUD.textLabel.text = "Login In"
    ...
    fileprivate func setupLayout() {
        ...
        backToRegisterButton.anchorForSwipe(top: nil, leading: view.leadingAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, trailing: view.trailingAnchor)
    }
